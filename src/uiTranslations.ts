...
export const FIELD_DESCRIPTIONS: Record<UILanguage, Array<{ match: RegExp; description: string }>> = {
  en: [
    ...
    { match: /^import_file_name$/, description: "Upload and import an .xlsx workbook through the Python backend. The selected file name is kept in the plot config; the file itself stays in browser memory." },
  ...
  de: [
    ...
    { match: /^import_file_name$/, description: "Lädt eine .xlsx-Arbeitsmappe über das Python-Backend hoch und importiert sie. Der gewählte Dateiname bleibt in der Plot-Konfiguration; die Datei selbst bleibt im Browser-Speicher." },
