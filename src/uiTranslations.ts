...
export const UI_LABELS: Record<UILanguage, Record<string, string>> = {
  en: {
    ...
    sourceModeFile: "Upload .xlsx",
    sourceModeDataset: "Provided dataset",
    sourceModeTeable: "Teable URL + API key",
    datasetName: "Dataset",
  ...
  de: {
    ...
    sourceModeFile: ".xlsx hochladen",
    sourceModeDataset: "Bereitgestelltes Dataset",
    sourceModeTeable: "Teable-URL + API-Schlüssel",
    datasetName: "Dataset",
    ...
    aboutReworkSuffix: "Gebaut als Teil von",
    aboutUiPrefix: "UI by",
    scaleLinear: "linear",
...
export const FIELD_DESCRIPTIONS: Record<UILanguage, Array<{ match: RegExp; description: string }>> = {
  en: [
    ...
    { match: /^_extensions\.source_mode$/, description: "Choose Teable, an uploaded .xlsx workbook, or a provided server dataset. Importing requires the Python backend server to be running." },
    { match: /^import_file_name$/, description: "Upload an .xlsx workbook, or point the dataframe at a provided server dataset. The selected file name is kept in the plot config." },
  ...
  de: [
    ...
    { match: /^_extensions\.source_mode$/, description: "Wählt Teable, eine hochgeladene .xlsx-Arbeitsmappe oder ein bereitgestelltes Server-Dataset. Für den Import muss der Python-Backend-Server laufen." },
    { match: /^import_file_name$/, description: "Lädt eine .xlsx-Arbeitsmappe hoch oder verweist auf ein bereitgestelltes Server-Dataset. Der gewählte Dateiname bleibt in der Plot-Konfiguration." },
